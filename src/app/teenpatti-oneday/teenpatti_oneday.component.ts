...
import { TeenpattiOneDayService } from './teenpatti_oneday.services';
...
@Component({
  ...
  templateUrl: './teenpatti_oneday.component.html',
  styleUrls: ['./teenpatti_oneday.component.css']
})
export class TeenpattiOneDayComponent implements OnInit, OnDestroy {
  ...
  constructor(public _sessionService: SessionService,
    public _teenpattiService: TeenpattiOneDayService,
  ...
  GetMarketList() {
    try {
      this.detailApiTimer = setTimeout(() => {
        if (this.route.url == '/teenpatti-oneday') {
