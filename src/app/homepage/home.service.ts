...
export class SportsListService {
  ...
  GetSports(sdata) {
    ...
    return this.http.post<any>(this.endpoint + "getSportOuterList", sdata, {
  ...
  getseiresMatchsList(sdata) {
    ...
    return this.http.post<any>(this.endpoint + "getseiresMatchsList", sdata, {
      headers: this._sessionService.setTokenHeader(),
    });
  }
  ...
  getMatchListBySeriesId(sdata) {
    ...
    return this.http.post<any>(
      this.endpoint + "getMatchOuterListBySeriesId",
      sdata,
      { headers: this._sessionService.setTokenHeader() }
    );
  }
  ...
  getBanner() {
    return this.http.get<any>(this.endpoint + "getBanner", {
      headers: this._sessionService.setTokenHeader(),
    });
  }

  getProviderList() {
    return this.http.get<any>(this.endpoint + "getmarchant", {
      headers: this._sessionService.setTokenHeader(),
    });
  }
  ...
  getCasinoList(sdata) {
    ...
    return this.http.post<any>(this.endpoint + "getCasinoList", sdata, {
      headers: this._sessionService.setTokenHeader(),
    });
  }
  ...
  getCasinoListByCategory(sdata) {
    ...
    return this.http.post<any>(
      this.endpoint + "getCasinoListByCategory",
      sdata,
      { headers: this._sessionService.setTokenHeader() }
    );
  }
