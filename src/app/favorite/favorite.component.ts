...
export class FavoriteComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._sportService.GetFavoriteMatchList(0);
  ...
  CheckSportExist(sId) {
    ...
    var isExist = false;
    if (this._sportService._ListFavoriteMatch != undefined) {
      for (var i = 0; i < this._sportService._ListFavoriteMatch.length; i++) {
        if (this._sportService._ListFavoriteMatch[i].sport_id == sId) {
          isExist = true;
          break;
        }
      }
