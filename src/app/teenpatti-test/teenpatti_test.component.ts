...
import { TeenpattiTestService } from './teenpatti_test.services';
...
@Component({
  ...
  templateUrl: './teenpatti_test.component.html',
  styleUrls: ['./teenpatti_test.component.css']
})
export class TeenpattiTestComponent implements OnInit, OnDestroy {
  ...
  constructor(public _sessionService: SessionService,
    public _teenpattiService: TeenpattiTestService,
  ...
  GetMarketList() {
    try {
      this.detailApiTimer = setTimeout(() => {
        if (this.route.url == '/teenpatti-test') {
