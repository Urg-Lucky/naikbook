...
import { ElectionService } from "./election.services";
import {
  FormBuilder,
  FormGroup,
  FormControl,
...
export class ElectionComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public _cricketServices: ElectionService,
  ...
  getMatchScoreBySportAndMatchId() {
    ...
    if (
      ...
      this.matchScore = setTimeout(
        () => {
          if (this.route.url == "/election-details") {
            var sdata = {
