...
import { Teenpatti7UpDownService } from './teenpatti_7updown.services';
...
@Component({
  ...
  templateUrl: './teenpatti_7updown.component.html',
  styleUrls: ['./teenpatti_7updown.component.css']
})
export class Teenpatti7UpDownComponent implements OnInit, OnDestroy {
  ...
  constructor(public _sessionService: SessionService,
    public _teenpattiService: Teenpatti7UpDownService,
