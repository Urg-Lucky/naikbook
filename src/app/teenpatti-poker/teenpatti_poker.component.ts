...
import { TeenpattiPokerService } from './teenpatti_poker.services';
...
@Component({
  ...
  templateUrl: './teenpatti_poker.component.html',
  styleUrls: ['./teenpatti_poker.component.css']
})
export class TeenpattiPokerComponent implements OnInit, OnDestroy {
  ...
  constructor(public _sessionService: SessionService,
    public _teenpattiService: TeenpattiPokerService,
