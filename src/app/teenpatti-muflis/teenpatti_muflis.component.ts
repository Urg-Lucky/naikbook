...
import { TeenpattiMuflisService } from './teenpatti_muflis.services';
...
@Component({
  ...
  templateUrl: './teenpatti_muflis.component.html',
  styleUrls: ['./teenpatti_muflis.component.css']
})
export class TeenpattiMuflisComponent implements OnInit, OnDestroy {
  ...
  constructor(public _sessionService: SessionService,
    public _teenpattiService: TeenpattiMuflisService,
  ...
  GetMarketList() {
    try {
      this.detailApiTimer = setTimeout(() => {
        if (this.route.url == '/teenpatti-muflis') {
