...
import { TeenpattiAaaService } from './teenpatti_aaa.services';
...
@Component({
  ...
  templateUrl: './teenpatti_aaa.component.html',
  styleUrls: ['./teenpatti_aaa.component.css']
})
export class TeenpattiAaaComponent implements OnInit, OnDestroy {
  ...
  constructor(public _sessionService: SessionService,
    public _teenpattiService: TeenpattiAaaService,
