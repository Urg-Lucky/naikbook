...
import { TeenpattiAndarBaharService } from './teenpatti_andarbahar.services';
...
@Component({
  ...
  templateUrl: './teenpatti_andarbahar.component.html',
  styleUrls: ['./teenpatti_andarbahar.component.css']
})
export class TeenpattiAndarBaharComponent implements OnInit, OnDestroy {
  ...
  constructor(public _sessionService: SessionService,
    public _teenpattiService: TeenpattiAndarBaharService,
  ...
  updateOldMatchDetailData(matchDetailData) {
    try {
      if (matchDetailData != null) {
        ...
        if (this.matchDetail.indexCard2.toString() != matchDetailData.indexCard2.toString()) {
          this.matchDetail.indexCard2 = matchDetailData.indexCard2;
        }
