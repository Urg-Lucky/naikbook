...
import { TeenpattiPassaService } from './teenpatti_passa.services';
...
@Component({
  ...
  templateUrl: './teenpatti_passa.component.html',
  styleUrls: ['./teenpatti_passa.component.css']
})
export class TeenpattiPassaComponent implements OnInit, OnDestroy {
  ...
  constructor(public _sessionService: SessionService,
    public _teenpattiService: TeenpattiPassaService,
